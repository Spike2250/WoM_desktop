...
from wom.settings.dep_omr import doc_dict, head_department, bed_profiles, rooms
...
class Ui_AddNewPatient(QtWidgets.QWidget,
    ...
    def __init__(self, user_info, windows, main_win, dictionary):
        ...
        msg = "World of Medicine - Отделение медицинской "\
              "реабилитации - Добавление нового пациента"
    ...
    def add_values_to_popup_lists(self):
        ...
        self.comboBoxPtRoomNumber.clear()
        self.comboBoxPtRoomNumber.addItems(rooms)
